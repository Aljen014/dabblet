...
<meta charset="utf-8" />
<title>loiter.us dabblet</title>
<meta name="author" content="Junqiang Wen" />
...
<link rel="stylesheet" href="/dabblet/style/global.css" />
<link rel="stylesheet" href="/dabblet/style/style.css" />
<script src="/dabblet/code/prefixfree.min.js"></script>
</head>
<body class="post">
<header>
	<h1><a href="/dabblet">dabblet</a></h1>
	
	<div class="with-inactive-dropdown">
		<a id="currentuser" target="_blank" class="user button">Log in</a>
		<menu class="dropdown">
			<a href="/dabblet/user/" target="_blank" class="command my-profile">My profile</a>
			<a href="/dabblet" onclick="Dabblet.user.logout()" class="command">Log out</a>
		</menu>
	</div>
	...
	<div class="with-dropdown" id="cloud">
		...
		<menu class="dropdown">
			<a href="/dabblet" onclick="Dabblet.wipe()" class="command" data-keyboard="⌘N">New dabblet</a>
...
<script src="/dabblet/code/utopia.js"></script>
<script src="/dabblet/code/selection.js"></script>
<script src="/dabblet/code/prism.js"></script>
<script src="/dabblet/code/code-highlight.js"></script>

<script src="/dabblet/code/editor.js"></script>
<!--[if lte IE 9]><script src="/code/classList.min.js"></script><![endif]-->
<script src="/dabblet/code/global.js"></script>
<script src="/dabblet/code/dabblet.js"></script>

<script src="/dabblet/code/previewers.js" async defer></script>
